 ...
 * Note that most beans will choose to receive references to collaborating beans via
 * corresponding bean properties or constructor arguments (Dependency Injection).
 *
 * <p>
...
public interface BeanFactoryAware extends Aware {
	 ...
	 * init-method.
	 * 
	 * @param beanFactory owning BeanFactory (never {@code null}). The bean can
