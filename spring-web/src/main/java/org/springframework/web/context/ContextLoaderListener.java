 ...
 * {@link WebApplicationContext}. Simply delegates to {@link ContextLoader} as
 * well as to {@link ContextCleanupListener}.
 *
 * <p>
 * This listener should be registered after
 * {@link org.springframework.web.util.Log4jConfigListener} in {@code web.xml},
 * if the latter is used.
 *
 * <p>
 * As of Spring 3.1, {@code ContextLoaderListener} supports injecting the root
 * web application context via the
 * {@link #ContextLoaderListener(WebApplicationContext)} constructor, allowing
 * for programmatic configuration in Servlet 3.0+ environments. See
...
public class ContextLoaderListener extends ContextLoader implements ServletContextListener {
    ...
    /**
     * ContextLoaderListener继承了ContextLoader，并且实现ServletContextListener接口。
     * 当Server容器（一般指tomcat）启动时，会收到事件初始化。
     */
    @Override
